...
public class PoliceStationDtos {

    public static class CreatePoliceStationRequest {
        @NotBlank
        private String name;
    ...
    public static class PoliceStationResponse {
        private Long id;
        private String name;
        private String address;
        private String city;
    ...
    public static PoliceStationResponse fromEntity(PoliceStation station) {
        PoliceStationResponse response = new PoliceStationResponse();
    ...
    public static PoliceStation toEntity(CreatePoliceStationRequest request) {
